...
public class ShhotKeyPressed : MonoBehaviour
{
    ...
    public void ShootKeyPressed(InputAction.CallbackContext context)
    {
    ...
    public void SpaceKeyPressed(InputAction.CallbackContext context)
    {
        if (IsPlayerOne())
            WKey.Invoke();
        else
